export function Footer() {
    return (
        <footer id="Contactame" className="space-y-3 w-full text-center bg-slate-950 py-4">
          
        <div className="flex flex-1 items-center justify-center align-middle space-x-2">
