  ...
  return (
    <>
      <body className=" ">
        ...
        <main className="w-full animate-fade-up animate-once animate-duration-[3000ms] animate-delay-100 grid place-content-center  ">
            ...
            <div className="ml-10 ">
              ...
              <div className=" space-y-1 ">
                ...
                <div className="flex space-x-3 mt-3">
                  <a
                    className="ml-1 rounded-full p-1  hover:bg-white  "
          ...
          <section className="relative top-44">
            <article >
              <h2 className="text-5xl text-white">Sobre mi</h2>
              <p></p>
            </article>
          </section>
        </main>
